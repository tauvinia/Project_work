...
# data <- st_intersection(data, boundary)
# 
# # Plot
# ggplot() +
...
# 
# # Save
# st_write(boundary, "data/boundary.gpkg")
# st_write(data, "data/small_data.gpkg")
```
...
Start point: Kriegsstraße 183, 76135 Karlsruhe, Deutschland
...
# Point in buffer
points_start_buffer <- st_intersection(data, start_buffer)
...
# Point in buffer
points_end_buffer <- st_intersection(data, end_buffer)
